...
-- But rather solved with actually defining lua snippets and diretcly expanding it.
-- Check keymap_snippets.lua
...
vim.keymap.set('n', '<leader>t<CR>', '<cmd>term<CR>i', { desc = 'Open terminal and enter insert mode' })
